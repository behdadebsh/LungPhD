...
branch_mapping = {
    1: {'Lobe': 'RUL', 'branch_name': 'Apical_lower', 'element': 49},
    2: {'Lobe': 'RUL', 'branch_name': 'Anterior_lower', 'element': 36},
    3: {'Lobe': 'RUL', 'branch_name': 'Apical_upper', 'element': 50},
    4: {'Lobe': 'RUL', 'branch_name': 'Posterior_upper', 'element': 51},
    5: {'Lobe': 'RUL', 'branch_name': 'Posterior_lower', 'element': 52},
    6: {'Lobe': 'RUL', 'branch_name': 'Anterior_upper', 'element': 35},
    7: {'Lobe': 'RML', 'branch_name': 'Medial_posterior', 'element': 60},
    8: {'Lobe': 'RML', 'branch_name': 'Lateral_anterior', 'element': 57},
    9: {'Lobe': 'RML', 'branch_name': 'Lateral_posterior', 'element': 58},
    10: {'Lobe': 'RML', 'branch_name': 'Medial_anterior', 'element': 59},
    11: {'Lobe': 'RLL', 'branch_name': 'Superior_lower', 'element': 54},
    12: {'Lobe': 'RLL', 'branch_name': 'Posterior', 'element': 66},
    13: {'Lobe': 'RLL', 'branch_name': 'Medial', 'element': 65},
    14: {'Lobe': 'RLL', 'branch_name': 'Anterior', 'element': 67},
    15: {'Lobe': 'RLL', 'branch_name': 'Superior_upper', 'element': 53},
    16: {'Lobe': 'RLL', 'branch_name': 'Lateral', 'element': 68},
    17: {'Lobe': 'LLL', 'branch_name': 'Superior_lower', 'element': 45},
    18: {'Lobe': 'LLL', 'branch_name': 'Lateral', 'element': 63},
    19: {'Lobe': 'LLL', 'branch_name': 'Posterior', 'element': 64},
    20: {'Lobe': 'LLL', 'branch_name': 'Anterior', 'element': 62},
    21: {'Lobe': 'LLL', 'branch_name': 'Medial', 'element': 61},
    22: {'Lobe': 'LLL', 'branch_name': 'Superior_upper', 'element': 46},
    23: {'Lobe': 'LUL', 'branch_name': 'Apical_upper', 'element': 43},
    24: {'Lobe': 'LUL', 'branch_name': 'Anterior_lower', 'element': 27},
    25: {'Lobe': 'LUL', 'branch_name': 'Lingular_lateral', 'element': 29},
    26: {'Lobe': 'LUL', 'branch_name': 'Posterior_upper', 'element': 41},
    27: {'Lobe': 'LUL', 'branch_name': 'Apical_lower', 'element': 44},
    28: {'Lobe': 'LUL', 'branch_name': 'Posterior_lower', 'element': 42},
    29: {'Lobe': 'LUL', 'branch_name': 'Anterior_upper', 'element': 28},
    30: {'Lobe': 'LUL', 'branch_name': 'Lingular_medial', 'element': 30},
}
