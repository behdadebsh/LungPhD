...
branch_mapping = {
    1: {'Lobe': 'RUL', 'branch_name': 'Apical_upper', 'element': 49},
    2: {'Lobe': 'RUL', 'branch_name': 'Anterior_lower', 'element': 35},
    3: {'Lobe': 'RUL', 'branch_name': 'Apical_lower', 'element': 50},
    4: {'Lobe': 'RUL', 'branch_name': 'Posterior_upper', 'element': 51},
    5: {'Lobe': 'RUL', 'branch_name': 'Posterior_lower', 'element': 52},
    6: {'Lobe': 'RUL', 'branch_name': 'Anterior_upper', 'element': 36},
    7: {'Lobe': 'RML', 'branch_name': 'Lateral_posterior', 'element': 57},
    8: {'Lobe': 'RML', 'branch_name': 'Medial Anterior', 'element': 60},
    9: {'Lobe': 'RML', 'branch_name': 'Lateral_anterior', 'element': 58},
    10: {'Lobe': 'RML', 'branch_name': 'Medial_posterior', 'element': 59},
    11: {'Lobe': 'RLL', 'branch_name': 'Medial', 'element': 65},
    12: {'Lobe': 'RLL', 'branch_name': 'Superior_lateral', 'element': 53},
    13: {'Lobe': 'RLL', 'branch_name': 'Lateral', 'element': 67},
    14: {'Lobe': 'RLL', 'branch_name': 'Superior_upper', 'element': 54},
    15: {'Lobe': 'RLL', 'branch_name': 'Anterior', 'element': 66},
    16: {'Lobe': 'RLL', 'branch_name': 'Posterior', 'element': 68},
    17: {'Lobe': 'LLL', 'branch_name': 'Lateral', 'element': 45},
    18: {'Lobe': 'LLL', 'branch_name': 'Superior_upper', 'element': 64},
    19: {'Lobe': 'LLL', 'branch_name': 'Medial', 'element': 62},
    20: {'Lobe': 'LLL', 'branch_name': 'Posterior', 'element': 61},
    21: {'Lobe': 'LLL', 'branch_name': 'Anterior', 'element': 46},
    22: {'Lobe': 'LLL', 'branch_name': 'Superior_lower', 'element': 63},
    23: {'Lobe': 'LUL', 'branch_name': 'Anterior_lower', 'element': 28},
    24: {'Lobe': 'LUL', 'branch_name': 'Posterior_upper', 'element': 43},
    25: {'Lobe': 'LUL', 'branch_name': 'Apical_upper', 'element': 41},
    26: {'Lobe': 'LUL', 'branch_name': 'Lingular_medial', 'element': 30},
    27: {'Lobe': 'LUL', 'branch_name': 'Posterior_lower', 'element': 44},
    28: {'Lobe': 'LUL', 'branch_name': 'Apical_lower', 'element': 42},
    29: {'Lobe': 'LUL', 'branch_name': 'Lingular_lateral', 'element': 29},
    30: {'Lobe': 'LUL', 'branch_name': 'Anterior_upper', 'element': 27},
}
cluster_directory = os.path.join(subject_path, 'Intensity_mapping')
lobes = ['RUL', 'RML', 'RLL', 'LUL', 'LLL']
nodes = []
for lobe in lobes:
    with open(os.path.join(cluster_directory, lobe + '_cluster_map_terminals_TTTTTT' + '.exnode')) as lobe_file:
...
# compare flow
# sum = 0
output_file_path = os.path.join(subject_path, 'Intensity_mapping', 'flow_comparison.log')
...
output_file_path = os.path.join(subject_path, 'Lobe', 'flow_comparison.log')
