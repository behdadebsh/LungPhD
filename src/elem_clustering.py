...
def main():
    ...
    sacre_bleu = KMeans(n_clusters=12).fit(X)
    ...
    for cluster in range(len(clusters)):
        if clusters[cluster][1] > 0:  # underperfused
            print("Underperfused:", cluster+17, "Avg. Intensity:", clusters[cluster][1])
    ...
    export_path = '/hpc/bsha219/lung/Data/CTEPH/CTEPH10/FRC/Intensity_mapping/'
