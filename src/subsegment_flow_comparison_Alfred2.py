...
branch_mapping = {
    ...
    3: {'Lobe': 'RUL', 'branch_name': 'Anterior_upper', 'element': 36},
    4: {'Lobe': 'RUL', 'branch_name': 'Posterior_upper', 'element': 51},
    5: {'Lobe': 'RUL', 'branch_name': 'Apical_lower', 'element': 49},
    6: {'Lobe': 'RUL', 'branch_name': 'Apical_upper', 'element': 50},
    7: {'Lobe': 'RML', 'branch_name': 'Lateral_posterior', 'element': 57},
    8: {'Lobe': 'RML', 'branch_name': 'Lateral_anterior', 'element': 60},
    9: {'Lobe': 'RML', 'branch_name': 'Medial_anterior', 'element': 59},
    10: {'Lobe': 'RML', 'branch_name': 'Lateral_anterior', 'element': 58},
    11: {'Lobe': 'RLL', 'branch_name': 'Superior_lateral', 'element': 53},
    12: {'Lobe': 'RLL', 'branch_name': 'Medial', 'element': 67},
    13: {'Lobe': 'RLL', 'branch_name': 'Lateral', 'element': 66},
    14: {'Lobe': 'RLL', 'branch_name': 'Anterior', 'element': 65},
    15: {'Lobe': 'RLL', 'branch_name': 'Superior_medial', 'element': 54},
    16: {'Lobe': 'RLL', 'branch_name': 'Posterior', 'element': 68},
    17: {'Lobe': 'LLL', 'branch_name': 'Medial', 'element': 64},
    18: {'Lobe': 'LLL', 'branch_name': 'Anterior', 'element': 62},
    19: {'Lobe': 'LLL', 'branch_name': 'Lateral', 'element': 61},
    20: {'Lobe': 'LLL', 'branch_name': 'Posterior', 'element': 63},
    21: {'Lobe': 'LLL', 'branch_name': 'Superior_upper', 'element': 45},
    22: {'Lobe': 'LLL', 'branch_name': 'Superior_lower', 'element': 46},
    23: {'Lobe': 'LUL', 'branch_name': 'Apical_lower', 'element': 41},
    24: {'Lobe': 'LUL', 'branch_name': 'Lingular_lower', 'element': 30},
    25: {'Lobe': 'LUL', 'branch_name': 'Posterior_upper', 'element': 44},
    26: {'Lobe': 'LUL', 'branch_name': 'Posterior_lower', 'element': 43},
    27: {'Lobe': 'LUL', 'branch_name': 'Anterior_lower', 'element': 27},
    28: {'Lobe': 'LUL', 'branch_name': 'Lingular_upper', 'element': 29},
    29: {'Lobe': 'LUL', 'branch_name': 'Apical_upper', 'element': 42},
    30: {'Lobe': 'LUL', 'branch_name': 'Anterior_upper', 'element': 28},
}
